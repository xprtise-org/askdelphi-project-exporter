...
{
    public class ImolaProcessTopicPublisher(
        ILogger<ImolaProcessTopicPublisher> logger,
            ...
            ) : TopicPublisherBase(logger, publicationSettings, askDelphiTopicClient, askDelphiResourceClient, askDelphiRelationsClient, fs), ITopicPublisher
    {
        ...
        private readonly ILogger<ImolaProcessTopicPublisher> logger = logger;
        ...
        public bool IsPublisherFor(IAskdelphiPublisherContext context, string topicNamespace) => "http://tempuri.org/imola-process".Equals(topicNamespace, StringComparison.OrdinalIgnoreCase);
        ...
        public async Task<string?> PublishTopic(IAskdelphiPublisherContext context, TopicListEntryIdentifier topicListEntry, ResponseTopicVersionHistoryTableModel versionForPublicationStage)
        {
            ...
            try
            {
                ...
                ProcessModel result = new()
                {
                    ...
                    Tags = tags,
                    Body = PartsHelper.GetString(getPartsResponse, "content", "content", "introduction")
                };
