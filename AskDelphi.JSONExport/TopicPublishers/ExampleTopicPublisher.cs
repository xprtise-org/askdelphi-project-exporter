...
namespace AskDelphi.JSONExport.TopicPublishers
{
    public class ExampleTopicPublisher(
        ILogger<ExampleTopicPublisher> logger,
            ...
            ) : TopicPublisherBase(logger, publicationSettings, askDelphiTopicClient, askDelphiResourceClient, askDelphiRelationsClient, fs), ITopicPublisher
    {
        ...
        private readonly ILogger<ExampleTopicPublisher> logger = logger;
        ...
        public bool IsPublisherFor(IAskdelphiPublisherContext context, string topicNamespace) => "http://tempuri.org/imola-example".Equals(topicNamespace, StringComparison.OrdinalIgnoreCase);
