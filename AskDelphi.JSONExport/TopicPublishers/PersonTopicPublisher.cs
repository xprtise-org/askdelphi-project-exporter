...
namespace AskDelphi.JSONExport.TopicPublishers
{
    public class PersonTopicPublisher(
        ILogger<PersonTopicPublisher> logger,
            ...
            ) : TopicPublisherBase(logger, publicationSettings, askDelphiTopicClient, askDelphiResourceClient, askDelphiRelationsClient, fs), ITopicPublisher
    {
        ...
        private readonly ILogger<PersonTopicPublisher> logger = logger;
        ...
        public bool IsPublisherFor(IAskdelphiPublisherContext context, string topicNamespace) => "http://tempuri.org/imola-person".Equals(topicNamespace, StringComparison.OrdinalIgnoreCase);
        ...
        public async Task<string?> PublishTopic(IAskdelphiPublisherContext context, TopicListEntryIdentifier topicListEntry, ResponseTopicVersionHistoryTableModel versionForPublicationStage)
        {
            ...
            try
            {
                ...
                PersonModel result = new()
                {
                    ...
                    Tags = tags,
                    Body = PartsHelper.GetString(getPartsResponse, "content", "content", "body"),
                    EMail = PartsHelper.GetString(getPartsResponse, "content", "content", "email"),
                    ProfileURL = PartsHelper.GetString(getPartsResponse, "content", "content", "profile-url")
                };
