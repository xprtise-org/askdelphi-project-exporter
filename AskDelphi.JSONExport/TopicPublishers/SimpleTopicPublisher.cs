...
namespace AskDelphi.JSONExport.TopicPublishers
{
    public class SimpleTopicPublisher(
        ILogger<SimpleTopicPublisher> logger,
            ...
            ) : TopicPublisherBase(logger, publicationSettings, askDelphiTopicClient, askDelphiResourceClient, askDelphiRelationsClient, fs), ITopicPublisher
    {
        ...
        private readonly ILogger<SimpleTopicPublisher> logger = logger;
        ...
        public bool IsPublisherFor(IAskdelphiPublisherContext context, string topicNamespace) => "http://tempuri.org/imola-simple-topic".Equals(topicNamespace, StringComparison.OrdinalIgnoreCase);
