...
{
    public class MenuTopicPublisher(
        ILogger<MenuTopicPublisher> logger,
            ...
            ) : TopicPublisherBase(logger, publicationSettings, askDelphiTopicClient, askDelphiResourceClient, askDelphiRelationsClient, fs), ITopicPublisher
    {
        ...
        private readonly ILogger<MenuTopicPublisher> logger = logger;
        ...
        public bool IsPublisherFor(IAskdelphiPublisherContext context, string topicNamespace) => "http://tempuri.org/imola-menu".Equals(topicNamespace, StringComparison.OrdinalIgnoreCase);
        ...
        public async Task<string?> PublishTopic(IAskdelphiPublisherContext context, TopicListEntryIdentifier topicListEntry, ResponseTopicVersionHistoryTableModel versionForPublicationStage)
        {
            ...
            try
            {
                ...
                MenuModel result = new()
                {
                    ...
                    Tags = tags,
                    Menu = PartsHelper.GetMenu(getPartsResponse, "content", "content", "menu-editor"),
                };
