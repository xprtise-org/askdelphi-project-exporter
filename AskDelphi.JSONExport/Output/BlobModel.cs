...
{
    public class BlobModel : IModelWithBasicData, IModelWithThumbnail, IModelWithKeyVisual, IModelWithRelatedContent
    {
        /// <summary>
        ...
        /// <summary>
        /// Name of the blob resource.
        /// </summary>
        public string? BlobResourceFile { get; set; }
    }
}
