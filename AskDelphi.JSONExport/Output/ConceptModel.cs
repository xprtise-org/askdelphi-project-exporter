...
{
    public class ConceptModel : IModelWithBasicData, IModelWithThumbnail, IModelWithKeyVisual, IModelWithRelatedContent
    {
        /// <summary>
        ...
        /// List of parts.
        /// </summary>
        public List<ConceptStepModel> Parts { get; set; } = [];
