namespace AskDelphi.EditingAPI.DTO.HomepageTopicDTO.Models
{
    ...
    /// </summary>
    public class RequestHomepageTabContentGroupUpdateModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Indicates selected layout for this group
        /// </summary>
        ...
        /// </summary>
        public List<RequestHomepageTabContentGroupItemUpdateModel> Items { get; set; }
    }
}
